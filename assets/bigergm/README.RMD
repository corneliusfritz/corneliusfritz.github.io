...
<!-- badges: start -->
[![CRAN status](https://www.r-pkg.org/badges/version/bigergm)](https://CRAN.R-project.org/package=bigergm)
<!-- badges: end -->
...
See the [vignette](articles/bigergm.html) for a detailed introduction to the package.

### Installing on Mac OS

Some Mac OS users may encounter the following error when installing `bigergm`:
