---
layout: single
title: "bigergm Workshop"
permalink: /bigergm-workshop/
classes: wide
---

This page contains the presentation slides and materials from the workshop on **bigergm**.
...
<div class="software-grid">
  ...
  <div class="software-card" style="margin-bottom: 1.5em;">
    ...
    <p style="font-size: 0.95em; color: #515154; line-height: 1.5; margin-bottom: 1.2em;">
      Exponential-family models for big networks.
    </p>
    <div class="software-actions">
      <a href="{{ '/assets/pdf/bigergm_sunbelt.pdf' | relative_url }}" target="_blank" class="btn btnId btnPub--download">
  ...
  <div class="software-card" style="margin-bottom: 1.5em;">
    <h3 class="software-title">Slides: bigergm Overview</h3>
    <p class="software-subtitle" style="font-size: 0.95em; color: #6e6e73; margin-bottom: 0.8em;">Presented by Cornelius Fritz</p>
    <p style="font-size: 0.95em; color: #515154; line-height: 1.5; margin-bottom: 1.2em;">
      A comprehensive guide on fitting, simulating, and diagnosing big network models.
    </p>
    <div class="software-actions">
      <a href="{{ '/presentation/bigergm.html' | relative_url }}" target="_blank" class="btn btnId btnPub--supplement">
