...
This page contains the presentation slides and materials from the workshop on **iglm**.
...
<div class="software-grid">
  ...
  <div class="software-card" style="margin-bottom: 1.5em;">
    ...
    <p style="font-size: 0.95em; color: #515154; line-height: 1.5; margin-bottom: 1.2em;">
      Overview of the statistical framework for regression under interference in connected populations.
    </p>
  ...
  <div class="software-card" style="margin-bottom: 1.5em;">
    ...
    <p style="font-size: 0.95em; color: #515154; line-height: 1.5; margin-bottom: 1.2em;">
      Hands-on applications and computational details of the iglm software package.
    </p>
    <div class="software-actions">
