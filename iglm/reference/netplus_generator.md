...
The \`netplus\` class is a container for storing, validating, and
...
- [`netplus_generator$new()`](#method-netplus-new)

- [`netplus_generator$gather()`](#method-netplus-gather)

- [`netplus_generator$save()`](#method-netplus-save)

- [`netplus_generator$density_z()`](#method-netplus-density_z)

- [`netplus_generator$density_x()`](#method-netplus-density_x)

- [`netplus_generator$density_y()`](#method-netplus-density_y)

- [`netplus_generator$edgewise_shared_partner()`](#method-netplus-edgewise_shared_partner)

- [`netplus_generator$set_neighborhood_overlap()`](#method-netplus-set_neighborhood_overlap)

- [`netplus_generator$dyadwise_shared_partner()`](#method-netplus-dyadwise_shared_partner)

- [`netplus_generator$geodesic_distances_distribution()`](#method-netplus-geodesic_distances_distribution)

- [`netplus_generator$geodesic_distances()`](#method-netplus-geodesic_distances)

- [`netplus_generator$edgewise_shared_partner_distribution()`](#method-netplus-edgewise_shared_partner_distribution)

- [`netplus_generator$dyadwise_shared_partner_distribution()`](#method-netplus-dyadwise_shared_partner_distribution)

- [`netplus_generator$degree_distribution()`](#method-netplus-degree_distribution)

- [`netplus_generator$degree()`](#method-netplus-degree)

- [`netplus_generator$spillover_degree_distribution()`](#method-netplus-spillover_degree_distribution)

- [`netplus_generator$plot()`](#method-netplus-plot)

- [`netplus_generator$print()`](#method-netplus-print)

- [`netplus_generator$clone()`](#method-netplus-clone)

------------------------------------------------------------------------

### Method `new()`

Create a new \`netplus\` object, that includes data on two attributes
and one network.

#### Usage

    netplus_generator$new(
      x_attribute = NULL,
      y_attribute = NULL,
      z_network = NULL,
      neighborhood = NULL,
...
A new \`netplus\` object.

------------------------------------------------------------------------

### Method `gather()`

Gathers the current state of the \`netplus\` object into a list. This
includes all attributes, network, and configuration details necessary to
reconstruct the object later.

#### Usage

    netplus_generator$gather()

#### Returns

A list containing the current state of the \`netplus\` object.

------------------------------------------------------------------------

### Method [`save()`](https://rdrr.io/r/base/save.html)

Saves the current state of the \`netplus\` object to a specified file
...
The \`netplus\` object itself (\`self\`), invisibly.
...
#### Usage
    ...
    netplus_generator$edgewise_shared_partner(type = "ALL")
...
#### Usage
    ...
    netplus_generator$set_neighborhood_overlap(neighborhood, overlap)
...
#### Usage
    ...
    netplus_generator$dyadwise_shared_partner(type = "ALL")
...
#### Usage
    ...
    netplus_generator$geodesic_distances_distribution(
      value_range = NULL,
      prob = TRUE
    )
...
#### Usage
    ...
    netplus_generator$geodesic_distances()
...
#### Usage
    ...
    netplus_generator$edgewise_shared_partner_distribution(
      type = "ALL",
      value_range = NULL,
      prob = TRUE
    )
...
#### Usage
    ...
    netplus_generator$dyadwise_shared_partner_distribution(
      type = "ALL",
      value_range = NULL,
      prob = TRUE
    )
...
#### Usage
    ...
    netplus_generator$degree_distribution(value_range = NULL, prob = TRUE)
...
#### Usage
    ...
    netplus_generator$spillover_degree_distribution(
      prob = TRUE,
      value_range = NULL
    )
...
#### Usage
    ...
    netplus_generator$print(digits = 3, ...)
...
#### Usage
    ...
    netplus_generator$clone(deep = FALSE)
